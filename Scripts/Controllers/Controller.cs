...
namespace Top_Down_shooter.Scripts.Controllers
{
    ...
    static class Controller
    {
        ...
        public static void MouseHandler(object sender, DoWorkEventArgs e)
        {
            while (true)
            {
                if (IsKeyPressed(Keys.VK_LBUTTON))
                {
